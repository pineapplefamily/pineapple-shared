...
export const GC_LABELS: Record<string, Record<string, string>> = {
  ...
  gc_felony_partner: {
    ...
    yes: 'Yes',
    not_sure: 'Not sure',
    live_alone: 'Not applicable (single)',
  },
  gc_bmi_remediation: {
    working_on_it: 'Working on it',
    proceed_anyway: 'Proceed anyway',
    pause: 'Pause my application',
  },
  gc_chronic_conditions: {
    ...
    type_2_diabetes_controlled: 'Type 2 diabetes (controlled)',
    depression_treated: 'Depression (treated)',
    anxiety_treated: 'Anxiety (treated)',
    thyroid_treated: 'Thyroid condition (treated)',
    asthma: 'Asthma',
    allergies: 'Allergies',
    none: 'None of the above',
  },
  gc_condition_medications: {
    psychiatric: 'Psychiatric conditions',
    cardiovascular: 'Heart or blood pressure conditions',
    diabetes: 'Diabetes or blood sugar management',
    blood_thinners: 'Blood clotting conditions',
    autoimmune: 'Autoimmune conditions',
    none: 'None of the above',
  },
  gc_pregnancy_complications: {
    none: 'None',
    gestational_diabetes: 'Gestational diabetes',
    preeclampsia: 'Preeclampsia',
    preterm_labor: 'Preterm labor',
    csection: 'C-section complication',
    placenta_previa: 'Placenta previa',
    other: 'Other',
  },
  gc_currently_pregnant: {
    yes: 'Yes',
    no: 'No',
  },
  gc_ip_types_open_to: {
    ...
    existing_children: 'Parents with existing children',
    international: 'International IPs',
    no_preference: 'No preference',
  },
  gc_ob_clearance: {
    yes_cleared: 'Yes — cleared by OB',
    scheduled: 'Scheduled — appointment coming up',
    not_yet: 'Not yet — plan to schedule',
    not_required: 'No OB/GYN currently',
  },
  gc_psych_eval: {
    yes_completed: 'Yes — completed',
    scheduled: 'Scheduled',
    not_yet: 'Not yet — willing to complete',
    not_required: 'No — have concerns',
  },
};
...
export const ED_LABELS: Record<string, Record<string, string>> = {
  ...
  ovarian_status: {
    both: 'Both ovaries present',
    one_removed: 'One ovary removed',
    both_removed: 'Both ovaries removed',
    unsure: 'Not sure',
  },
  travel_willingness: {
    local_only: 'Local only',
  ...
  future_contact_willingness: {
    open: 'Open to contact',
    maybe: 'Maybe',
    no: 'No contact preferred',
  },
  relationship_status: {
    single: 'Single',
    in_relationship: 'In a relationship',
...
export const IP_LABELS: Record<string, Record<string, string>> = {
  ...
  partnership_type: {
    same_sex: 'Same-sex couple',
    different_sex: 'Different-sex couple',
    prefer_not_to_say: 'Prefer not to say',
  },
  embryo_status: {
    ready: 'Embryos ready',
    creating: 'Currently creating embryos',
    none: 'No embryos yet',
    unsure: 'Not sure',
  },
  gc_experience_preference: {
    experienced_only: 'Experienced GCs only',
    prefer_experienced: 'Prefer experienced',
    no_preference: 'No preference',
    not_sure: 'Not sure',
  },
  gc_location_preference: {
  ...
  donor_anonymity_preference: {
    ...
    semi_open: 'Semi-open',
    open_id: 'Open ID',
    known_fully_open: 'Open/Known',
    open_to_any: 'No preference',
  },
  donor_experience_preference: {
    proven_only: 'Proven donors only',
    prefer_proven: 'Prefer proven',
    no_preference: 'No preference',
    not_sure: 'Not sure',
  },
  employer_fertility_benefits: {
